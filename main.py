...
def build_result_rows(metrics: Dict[str, float]):
    labels = {
        "P_block": "Вероятность блокировки (отказа)",
        "P_wait": "Доля заявок, попавших в очередь",
        "P_immediate": "Доля заявок, обслуженных сразу после поступления",
        "P_abandon": "Доля ушедших из очереди",
        "P_out": "Доля необслуженных заявок",
        "L_q": "Средняя число заявок в очереди",
        "L_s": "Среднее число занятых каналов",
        "L": "Среднее число заявок в системе",
        "W_q": "Среднее время нахождения в очереди (для всех принятых заявок)",
        "W": "Среднее время пребывания заявок в системе",
        "W_q_given_wait": "Среднее время ожидания для попавших в очередь (включая ушедших)",
